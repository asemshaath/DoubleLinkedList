...
public class SortedDoubleLinkedListTest {
	...
	public void setUp() throws Exception {
		...
		//comparator = new StringComparator();
		//myTest = new SortedDoubleLinkedList<String>(comparator);
	...
	public void testIteratorSuccessfulStringPrevious() {
		...
		// begin - hello - world - zebra 
		
		System.out.println("In testIteratorSuccessfulStringPrevious ");
		...
		System.out.println(sortedLinkedString);
